 ...
 * @version 1.0.0
 * @since 1.0.7 Added meta key information for featured case study
...
function wap8_portfolio_help_tabs_content( $tab = 'wap8_portfolio_help_meta' ) {
	...
	if ( $tab == 'wap8_portfolio_help_template_tags' ) { // if template tags tab is active
		...
		ob_start(); // opening an output buffer to store the HTML content ?>
			...
			<p><?php _e( 'Included with Portfolio Mgmt. are eight template tags for you to display a list of custom taxonomies associated with a portfolio post.', 'wap8plugin-i18n' ); ?></p>
